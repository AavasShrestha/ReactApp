...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onToggle }) => {
  ...
  const navigation = [
    ...
    { name: 'Databases', href: '/databases', icon: Database, current: location.pathname === '/databases' },
    // { name: 'Logos', href: '/logos', icon: Image, current: location.pathname === '/logos' }
    { name: 'Logos', href: '/logos', icon: ImageIcon, current: location.pathname === '/logos' }
